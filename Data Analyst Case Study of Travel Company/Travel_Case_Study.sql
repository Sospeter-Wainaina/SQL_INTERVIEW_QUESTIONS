...
--Q4 Write a query to count the number of flight and hotel bookings in each of the user segments in 2022


SELECT 
U.SEGMENT,
COUNT( CASE WHEN B.LINE_OF_BUSINESS = 'Flight'  THEN B.USER_ID ELSE NULL END) AS FLIGHT_BOOKINGS,
COUNT( CASE WHEN B.LINE_OF_BUSINESS = 'Hotel' THEN B.USER_ID ELSE NULL END) AS HOTEL_BOOKINGS
FROM BOOKING_TABLE B 
